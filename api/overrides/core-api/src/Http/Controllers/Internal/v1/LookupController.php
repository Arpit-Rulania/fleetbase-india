...
/**
 * FleetIndia override — blog RSS phone-home disabled.
 *
 * Upstream fetches https://blog.fleetbase.io/rss/ (and related Fleetbase blog URLs).
 * When FLEETBASE_BLOG_DISABLED is truthy (default true in FleetIndia compose),
 * this returns an empty list and never contacts Fleetbase hosts.
 * Logged in CHANGES.md.
 */
class LookupController extends Controller
{
    ...
    {
        // FleetIndia: never pull Fleetbase blog RSS / Ghost hosts by default.
        $disabled = filter_var(env('FLEETBASE_BLOG_DISABLED', true), FILTER_VALIDATE_BOOLEAN);
        if ($disabled) {
